...
const AboutSection = () => {
  ...
  return (
    <section className="flex flex-col lg:flex-row w-full h-auto lg:h-[1000px] justify-between py-10">
      ...
      <div data-aos="fade-right" className="relative w-full h-[400px] lg:w-1/2 lg:h-full">
        <div className="absolute top-5 left-0 w-72 h-72 lg:w-96 lg:h-96 z-10">
          <Image className="rounded-lg" src="/images/eziimg2.webp" alt="Image 1" width={1000} height={1000} objectFit="cover" />
        </div>
        <div className="absolute top-40 left-20 w-64 h-64 lg:w-80 lg:h-80 z-20">
          <Image className="rounded-lg" src="/images/eziimg1.webp" alt="Image 2" width={1000} height={1000} objectFit="cover" />
        </div>
        <div className="absolute top-0 left-40 w-72 h-72 lg:w-96 lg:h-96 z-30">
          <Image className="rounded-lg" src="/images/eziimg3.webp" alt="Image 3" width={300} height={300} objectFit="cover" />
        </div>
      </div>

      {/* Right Div with Description and Button */}
      <div data-aos="fade-left" className="w-full lg:w-1/2 p-8 pt-40 lg:pt-20">
        ...
        <p className="font-bold text-lg text-gray-500 py-8">We equip future professionals with the essential tools to thrive in both traditional and digital IT landscapes.</p>
